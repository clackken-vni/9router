...
export const CLI_TOOLS = {
  ...
  amp: {
    ...
    defaultModels: [
      ...
      { id: "librarian", name: "Librarian (claude-sonnet-4-6)", alias: "claude-sonnet-4-6", defaultValue: "cc/claude-sonnet-4-6", description: "Librarian subagent — Claude Sonnet 4.6" },
      ...
      { id: "oracle", name: "Oracle (gpt-5.4)", alias: "gpt-5.4", defaultValue: "cx/gpt-5.4", description: "Oracle agent — GPT-5.4" },
